...
public class SuggestionsActivityFood extends AppCompatActivity implements View.OnClickListener {

    private ImageButton backButton, shoppingButton, entertainmentButton, transportationButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_suggestions_food);

        tinyDB = new TinyDB(this);

        backButton = findViewById(R.id.suggestions_imageButton_leftArrow);
        shoppingButton = findViewById(R.id.suggestionsFood_button_shopping);
        entertainmentButton = findViewById(R.id.suggestionsFood_button_entertainment);
        transportationButton = findViewById(R.id.suggestionsFood_button_transportation);
        suggestionList = findViewById(R.id.suggestionsFood_list_suggestions);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.suggestions_imageButton_leftArrow:
                openMainActivity();
                break;
            case R.id.suggestionsFood_button_shopping:
                openShoppingActivity();
                break;
            case R.id.suggestionsFood_button_entertainment:
                openEntertainmentActivity();
                break;
            case R.id.suggestionsFood_button_transportation:
                                                        ...
                                                        if (yelpTwoJSON.has("businesses")) {
                                                            ...
                                                            for (int i = 0; i < arrLen; i++) {
                                                                ...
                                                                if (yelpTwoArray.getJSONObject(i).getString("price").length() < price) {
                                                                    ...
                                                                    if (category.equalsIgnoreCase("Food and Dining")) {
