...
public class TinyDB {
    ...
    public ArrayList<Transaction> getListTransaction(String key) {
        String jsonTransactions = preferences.getString(key, "");
        Type type = new TypeToken<List<Transaction>>(){}.getType();
        ArrayList<Transaction> transactionsList = gson.fromJson(jsonTransactions, type);
...
//    }
    ...
    public void putListTransactions(String key, ArrayList<Transaction> transactionList) {
        checkForNullKey(key);
        preferences.edit().putString(key, gson.toJson(transactionList)).apply();
    }
